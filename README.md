...
**nf-core/pangenome** is a bioinformatics best-practise analysis pipeline for
...
4. Start running your own analysis!
    ...
    ```bash
    nextflow run nf-core/pangenome -profile <docker/singularity/podman/shifter/charliecloud/conda/institute> --input '*_R{1,2}.fastq.gz' --genome GRCh37
    ```
